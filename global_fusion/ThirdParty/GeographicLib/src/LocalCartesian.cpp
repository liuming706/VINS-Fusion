...
void LocalCartesian::IntForward(real lat, real lon, real h, real &x, real &y, real &z, real M[dim2_]) const
{
    real xc, yc, zc;
    ...
    if (M) MatrixMultiply(M);
}

void LocalCartesian::IntReverse(real x, real y, real z, real &lat, real &lon, real &h, real M[dim2_]) const
{
    real xc = _x0 + _r[0] * x + _r[1] * y + _r[2] * z, yc = _y0 + _r[3] * x + _r[4] * y + _r[5] * z,
