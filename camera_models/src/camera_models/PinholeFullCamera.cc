...
PinholeFullCamera::Parameters::Parameters(const std::string &cameraName,  //
                                          int w, int h, double k1, double k2, double k3, double k4, double k5,
...
void PinholeFullCamera::Parameters::writeToYamlFile(const std::string &filename) const
{
    ...
    fs << "{"
       << "k1" << m_k1 << "k2" << m_k2 << "k3" << m_k3 << "k4" << m_k4 << "k5" << m_k5 << "k6" << m_k6 << "p1" << m_p1
       << "p2" << m_p2 << "}";
...
PinholeFullCamera::PinholeFullCamera(const std::string &cameraName, int imageWidth, int imageHeight, double k1,
                                     double k2, double k3, double k4, double k5, double k6, double p1, double p2,
...
cv::Mat PinholeFullCamera::initUndistortRectifyMap(cv::Mat &map1, cv::Mat &map2, float fx, float fy, cv::Size imageSize,
...
const PinholeFullCamera::Parameters &PinholeFullCamera::getParameters(void) const
{
    return mParameters;
}
...
void PinholeFullCamera::writeParametersToYamlFile(const std::string &filename) const
{
